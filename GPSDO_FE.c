...
// ATTiny841 Fuse settings: lfuse=0xe0, hfuse = 0xd4, efuse = 0x1
...
#define LED1 _BV(PORTD2)
#define LED_DDR_PORT DDRD
#define LED_DDR (_BV(DDRD1) | _BV(DDRD2))
#else
...
#ifdef __AVR_ATmega328PB__
#define RDY_PORT PINB
#define OSC_RDY _BV(PINB2)
#define RDY_DDR _BV(DDRB2)
#define RDY_DDR_PORT DDRB
#define RDY_PU_PORT PORTB
#define OSC_RDY_PU _BV(PORTB2)
#else
